...
hide(document.getElementsByClassName('action-bar')[0])

var articleHeader = document.getElementsByClassName('article__header-premium')[0];
if(articleHeader){
    articleHeader.classList.remove('article__header-premium');
};
...
window.addEventListener('load', function() {
    ...
    document.querySelectorAll('span[class="story-card__label"]').forEach(e => {e.innerText = 'Free 😉'; return null;});
    hide(document.getElementById('premium-toaster'))
    document.querySelectorAll('section[class="article-offer"]').forEach(e => {e.style.display = 'none'; return null});
